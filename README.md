...
the core package from the `v0.7.2` Git tag:
...
```bash
uv add "imx-camera-toolkit[production-preview] @ git+https://github.com/bi3lu/imx-camera-toolkit.git@v0.7.2"
```
...
Pin the v0.7.2 release tag in the consuming project's `pyproject.toml`:

```toml
[project]
dependencies = [
    "imx-camera-toolkit @ git+https://github.com/bi3lu/imx-camera-toolkit.git@v0.7.2"
]
```
...
[project]
dependencies = [
    "imx-camera-toolkit[preview] @ git+https://github.com/bi3lu/imx-camera-toolkit.git@v0.7.2"
]
```
